...
class JFirebaseFirestore : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        botonOrderBy.setOnClickListener { consultarConOrdenBy(adaptador) }
    ...
    // Compuesto porque se trabaja con población y capital
    fun consultaIndiceCompuesto(
        ...
        citiesRefUnico
            ...
            .orderBy("population", com.google.firebase.firestore.Query.Direction.DESCENDING)
            .get()
    ...
    fun crearDatosPrueba() {
        ...
        cities.document("SF")   // Asigna un ID a San Francisco (opcional)
            .set(data1)
